"""
This version uses scale information to determine weight of the descriptors
"""
...
class DescExtractor(nn.Module):
    ...
    def forward(self, feats, scales):
        ...
        weight = scales - 1
        weighted = weight * down_descs + (1 - weight) * descs
...
class MSNetV2(nn.Module):
    ...
    def forward(self, data, targets=None):
        ...
        left_scale, right_scale = data['left_scale'], data['right_scale']
        
        # compute descriptor from C3
        descs0 = self.desc_extractor(images0, left_scale)
        descs1 = self.desc_extractor(images1, right_scale)
