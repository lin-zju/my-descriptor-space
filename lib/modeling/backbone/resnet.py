"""
    Resnet backbones. Each backbone should return a dictionary of features
"""
...
class ResNet(nn.Module):
    """
    Resnet adapted for descritpor extraction.
    """
...
class MultiResNet(nn.Module):
    def __init__(self, resnet, stage):
        """
        :param stage: can be 1 to 5, corresponding to C1 to C5.
        """
